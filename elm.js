...
var author$project$App$Footer$Messages$AdjustTimeZone = function (a) {
...
var author$project$App$Footer$Model$emptyModel = {
...
var author$project$App$Footer$Model$init = _Utils_Tuple2(
	author$project$App$Footer$Model$emptyModel,
	A2(elm$core$Task$perform, author$project$App$Footer$Messages$AdjustTimeZone, elm$time$Time$here));
var author$project$App$Messages$FooterMsg = function (a) {
	return {$: 'FooterMsg', a: a};
};
var author$project$App$Model$setFooterModel = F2(
	function (footer, model) {
		return _Utils_update(
			model,
			{footerModel: footer});
	});
var author$project$Utils$flip = function (func) {
	return function (b) {
		return function (a) {
			return A2(func, a, b);
		};
...
var author$project$App$Model$asFooterModelIn = author$project$Utils$flip(author$project$App$Model$setFooterModel);
var author$project$App$Model$Model = F5(
	function (storedModel, editMode, colorMap, theme, footerModel) {
		return {colorMap: colorMap, editMode: editMode, footerModel: footerModel, storedModel: storedModel, theme: theme};
	});
...
var author$project$App$Theme$ColorScheme$defaultColorMap = elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('base00', '2d2d2d'),
			_Utils_Tuple2('base01', '393939'),
			_Utils_Tuple2('base02', '515151'),
			_Utils_Tuple2('base03', '747369'),
			_Utils_Tuple2('base04', 'a09f93'),
...
var author$project$App$Theme$ColorScheme$initColorMap = function (map) {
	return A2(elm$core$Maybe$withDefault, author$project$App$Theme$ColorScheme$defaultColorMap, map);
};
var author$project$App$Theme$ColorScheme$defaultTheme = {
	addButton: {
		background: 'base00',
		expanded: {
			background: 'base03',
		...
		input: {background: 'base01', foreground: 'base05'},
		plusColor: 'base03'
	},
	background: 'base00',
	footer: {
...
var author$project$App$Theme$ColorScheme$initTheme = function (theme) {
	return A2(elm$core$Maybe$withDefault, author$project$App$Theme$ColorScheme$defaultTheme, theme);
};
var author$project$App$Model$emptyModel = function (stored) {
	return A5(
		author$project$App$Model$Model,
		stored,
		false,
		author$project$App$Theme$ColorScheme$initColorMap(elm$core$Maybe$Nothing),
...
var author$project$App$Model$init = function (maybeModel) {
	var _n0 = author$project$App$Footer$Model$init;
	var footerModel = _n0.a;
	var footerCmd = _n0.b;
	return _Utils_Tuple2(
		A2(
			author$project$App$Model$asFooterModelIn,
			author$project$App$Model$emptyModel(
				A2(elm$core$Maybe$withDefault, author$project$App$Model$emptyStoredModel, maybeModel)),
			footerModel),
		A2(elm$core$Platform$Cmd$map, author$project$App$Messages$FooterMsg, footerCmd));
};
var author$project$App$Footer$Messages$OnTime = function (a) {
	return {$: 'OnTime', a: a};
};
...
var author$project$App$Footer$Subscriptions$subscriptions = function (model) {
	return A2(elm$time$Time$every, 1000, author$project$App$Footer$Messages$OnTime);
};
var elm$core$Platform$Sub$map = _Platform_map;
var author$project$App$Subscriptions$subscriptions = function (model) {
	return A2(
		elm$core$Platform$Sub$map,
		author$project$App$Messages$FooterMsg,
		author$project$App$Footer$Subscriptions$subscriptions(model.footerModel));
};
...
var author$project$App$Update$setStorage = _Platform_outgoingPort(
	'setStorage',
	function ($) {
						...
						return elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'addMode',
									elm$json$Json$Encode$bool($.addMode)),
									_Utils_Tuple2(
									'categories',
											...
											return elm$json$Json$Encode$object(
												_List_fromArray(
													[
														...
														_Utils_Tuple2(
														'nameField',
														elm$json$Json$Encode$string($.nameField)),
														_Utils_Tuple2(
														'uid',
														elm$json$Json$Encode$int($.uid)),
														_Utils_Tuple2(
														'urlField',
														elm$json$Json$Encode$string($.urlField))
													]));
										})($.categories)),
									_Utils_Tuple2(
									'colorMode',
...
var author$project$App$CategoryTable$Category$Model$initEdit = function (previous) {
	return _Utils_update(
		previous,
		{addMode: false, nameField: '', urlField: ''});
};
var author$project$App$CategoryTable$Model$initEdit = function (previous) {
	return _Utils_update(
		previous,
		{
			addMode: false,
...
var author$project$App$CategoryTable$Category$Model$newCategory = F3(
	function (name, color, id) {
		return {addMode: false, color: color, id: id, links: _List_Nil, name: name, nameField: '', uid: 0, urlField: ''};
	});
var author$project$App$CategoryTable$Model$setCategories = F2(
	function (categories, model) {
		return _Utils_update(
			model,
			{categories: categories});
	});
var author$project$App$CategoryTable$Model$asCategoriesIn = author$project$Utils$flip(author$project$App$CategoryTable$Model$setCategories);
var author$project$App$CategoryTable$Model$addCategory = F2(
	function (category, model) {
		return A2(
			author$project$App$CategoryTable$Model$asCategoriesIn,
			model,
			_Utils_ap(
				model.categories,
				_List_fromArray(
...
var author$project$App$CategoryTable$Model$setUid = F2(
	function (uid, model) {
		return _Utils_update(
			model,
			{uid: uid});
	});
var author$project$App$CategoryTable$Category$Model$setLinks = F2(
	function (links, model) {
		return _Utils_update(
			model,
			{links: links});
	});
var author$project$App$CategoryTable$Category$Model$asLinksIn = author$project$Utils$flip(author$project$App$CategoryTable$Category$Model$setLinks);
var author$project$App$CategoryTable$Category$Model$addLink = F2(
	function (link, model) {
		return A2(
			author$project$App$CategoryTable$Category$Model$asLinksIn,
			model,
			_Utils_ap(
				model.links,
				_List_fromArray(
...
var author$project$App$CategoryTable$Category$Update$inputValidator = rtfeldman$elm_validate$Validate$any(
	_List_fromArray(
		[
			A2(
...
var author$project$App$CategoryTable$Link$Model$Model = F3(
	function (name, url, id) {
		return {id: id, name: name, url: url};
	});
var author$project$App$CategoryTable$Link$Model$newLink = F3(
	function (name, url, id) {
		return A3(author$project$App$CategoryTable$Link$Model$Model, name, url, id);
	});
...
var author$project$App$CategoryTable$Category$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'UpdateNameField':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'Add':
				var newUid = model.uid + 1;
				var newModel = author$project$App$CategoryTable$Category$Update$inputValidator(model) ? A2(
					author$project$App$CategoryTable$Category$Model$addLink,
					A3(author$project$App$CategoryTable$Link$Model$newLink, model.nameField, model.urlField, newUid),
					model) : model;
				return _Utils_Tuple2(
					_Utils_update(
						newModel,
...
var author$project$App$CategoryTable$Messages$CategoryMsg = F2(
	function (a, b) {
		return {$: 'CategoryMsg', a: a, b: b};
	});
...
var author$project$App$CategoryTable$Update$handleCategoryMsgPassthrough = F3(
	function (id, innerMsg, model) {
		var mayBeIndex = A2(
		...
		var selectedCategory = function () {
			var _n1 = A2(elm_community$list_extra$List$Extra$getAt, index, model.categories);
			if (_n1.$ === 'Just') {
				var category = _n1.a;
				return category;
			} else {
				return A3(author$project$App$CategoryTable$Category$Model$newCategory, '', '', -1);
			}
		}();
		var _n0 = A2(author$project$App$CategoryTable$Category$Update$update, innerMsg, selectedCategory);
		var updatedCategory = _n0.a;
		var cmdMsg = _n0.b;
		var categories = A3(elm_community$list_extra$List$Extra$setAt, index, updatedCategory, model.categories);
		return _Utils_Tuple2(
			A2(author$project$App$CategoryTable$Model$setCategories, categories, model),
			A2(
				elm$core$Platform$Cmd$map,
				author$project$App$CategoryTable$Messages$CategoryMsg(id),
				cmdMsg));
	});
var author$project$App$CategoryTable$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			...
			default:
				var id = msg.a;
				var categoryMsg = msg.b;
				if (categoryMsg.$ === 'RemoveCategory') {
					return _Utils_Tuple2(
						A2(
							author$project$App$CategoryTable$Model$asCategoriesIn,
							model,
					...
					return A3(author$project$App$CategoryTable$Update$handleCategoryMsgPassthrough, id, categoryMsg, model);
				}
		}
	});
var author$project$App$Footer$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var author$project$App$Messages$CategoryTableMsg = function (a) {
	return {$: 'CategoryTableMsg', a: a};
};
var author$project$App$Model$setCategoryTable = F2(
	function (table, model) {
		return _Utils_update(
			model,
			{categoryTable: table});
	});
var author$project$App$Model$asCategoryTableIn = author$project$Utils$flip(author$project$App$Model$setCategoryTable);
var author$project$App$Model$setStoredModel = F2(
	function (stored, model) {
		return _Utils_update(
			model,
			{storedModel: stored});
	});
var author$project$App$Model$asStoredModelIn = author$project$Utils$flip(author$project$App$Model$setStoredModel);
var author$project$App$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			case 'CategoryTableMsg':
				var tableMsg = msg.a;
				var _n1 = A2(author$project$App$CategoryTable$Update$update, tableMsg, model.storedModel.categoryTable);
				var tableModel = _n1.a;
				var tableCmd = _n1.b;
				return _Utils_Tuple2(
					A2(
						author$project$App$Model$asStoredModelIn,
						model,
						A2(author$project$App$Model$asCategoryTableIn, model.storedModel, tableModel)),
					A2(elm$core$Platform$Cmd$map, author$project$App$Messages$CategoryTableMsg, tableCmd));
			case 'ToggleEditMode':
				var updatedEditMode = !model.editMode;
				var storedModel = updatedEditMode ? A2(
					author$project$App$Model$asCategoryTableIn,
					model.storedModel,
					author$project$App$CategoryTable$Model$initEdit(model.storedModel.categoryTable)) : model.storedModel;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{editMode: updatedEditMode, storedModel: storedModel}),
					elm$core$Platform$Cmd$none);
			default:
				var footerMsg = msg.a;
				var _n2 = A2(author$project$App$Footer$Update$update, footerMsg, model.footerModel);
				var footerModel = _n2.a;
				var footerCmd = _n2.b;
				return _Utils_Tuple2(
					A2(author$project$App$Model$asFooterModelIn, model, footerModel),
					A2(elm$core$Platform$Cmd$map, author$project$App$Messages$FooterMsg, footerCmd));
		}
	});
var author$project$App$Update$updateWithStorage = F2(
	function (msg, model) {
		var _n0 = A2(author$project$App$Update$update, msg, model);
		var newModel = _n0.a;
		var cmds = _n0.b;
		return _Utils_Tuple2(
			newModel,
...
var author$project$App$Theme$ColorScheme$fromColorMap = F2(
	function (value, map) {
		var _n0 = A2(elm$core$Dict$get, value, map);
		if (_n0.$ === 'Just') {
			var color = _n0.a;
			return color;
		} else {
			return author$project$App$Theme$ColorScheme$defaultColor;
		}
	});
...
var author$project$App$Theme$ColorScheme$mapSelector = function (map) {
	return function (c) {
		return rtfeldman$elm_css$Css$hex(
			A2(author$project$App$Theme$ColorScheme$fromColorMap, c, map));
	};
};
var author$project$App$CategoryTable$Messages$Add = {$: 'Add'};
var author$project$App$CategoryTable$Messages$AddMode = {$: 'AddMode'};
		...
		var content = A3(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$class('plus'),
							rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$App$CategoryTable$Messages$AddMode),
							rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$App$CategoryTable$Messages$UpdateField),
							author$project$Utils$onEnter(author$project$App$CategoryTable$Messages$Add),
							rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[
...
var author$project$App$CategoryTable$Category$Messages$Add = {$: 'Add'};
var author$project$App$CategoryTable$Category$Messages$AddMode = {$: 'AddMode'};
var author$project$App$CategoryTable$Category$Messages$UpdateNameField = function (a) {
	return {$: 'UpdateNameField', a: a};
};
var author$project$App$CategoryTable$Category$Messages$UpdateUrlField = function (a) {
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$class('plus'),
							rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$App$CategoryTable$Category$Messages$AddMode),
							rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Name'),
							rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$App$CategoryTable$Category$Messages$UpdateNameField),
							author$project$Utils$onEnter(author$project$App$CategoryTable$Category$Messages$Add),
							rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Url'),
							rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$App$CategoryTable$Category$Messages$UpdateUrlField),
							author$project$Utils$onEnter(author$project$App$CategoryTable$Category$Messages$Add),
							rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[
...
var author$project$App$CategoryTable$Category$Messages$RemoveLink = function (a) {
...
var author$project$App$CategoryTable$Link$View$view = F3(
	function (wrapped, editMode, model) {
		var linkAttr = editMode ? _List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Events$onClick(
				author$project$App$CategoryTable$Category$Messages$RemoveLink(model.id)),
				rtfeldman$elm_css$Html$Styled$Attributes$href('#')
			]) : _List_fromArray(
			[
				rtfeldman$elm_css$Html$Styled$Attributes$href(model.url)
			]);
		var attributes = A2(
			elm$core$List$cons,
			rtfeldman$elm_css$Html$Styled$Attributes$css(
		...
		var title = A2(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[author$project$App$CategoryTable$Category$View$titleStyle]))
				]),
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$text(model.name)
...
var author$project$App$Footer$View$viewEdit = F2(
	function (wrapped, editMode) {
		...
		return A2(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$App$Messages$ToggleEditMode),
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
...
var author$project$App$Footer$View$viewTime = F3(
	function (wrapped, time, zone) {
		...
		return A2(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$text(printedHour + (':' + printedMinute))
				]));
	});
...
var author$project$App$View$greetingFont = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var author$project$App$View$viewGreeting = F2(
	function (wrapped, greeting) {
		return A2(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$text(greeting)
				]));
	});
...
var author$project$Main$main = elm$browser$Browser$document(
	{init: author$project$App$Model$init, subscriptions: author$project$App$Subscriptions$subscriptions, update: author$project$App$Update$updateWithStorage, view: author$project$App$View$view});
						...
						return A2(
							...
							function (categoryTable) {
								return elm$json$Json$Decode$succeed(
									{categoryTable: categoryTable, greeting: greeting});
							},
							A2(
